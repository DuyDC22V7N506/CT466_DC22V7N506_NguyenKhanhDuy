...
config.py
---------
Tập trung toàn bộ hằng số cấu hình cho pipeline phân cụm RFM.
Thay đổi tham số tại đây để áp dụng xuyên suốt toàn bộ project.
"""

# ── Dữ liệu ──────────────────────────────────────────────────────────────────
RFM_FEATURES: list[str] = ["Recency", "Frequency", "Monetary"]
INPUT_FILE: str = "customer_rfm_small.csv"
OUTPUT_FILE: str = "output_results.csv"
